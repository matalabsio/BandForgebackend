-- Academic Mock 4 (M04 / Test 4) — unpublished until Reading/Writing exist.
-- Listening questions seeded separately (m04_listening_sN_seed.sql).
...
VALUES
  ('a0000000-0000-4000-8000-000000000004', 'listening', 1, 30, true),
  ('a0000000-0000-4000-8000-000000000004', 'reading', 2, 30, false),
  ('a0000000-0000-4000-8000-000000000004', 'writing', 3, 60, false),
  ('a0000000-0000-4000-8000-000000000004', 'speaking', 4, 14, false)
