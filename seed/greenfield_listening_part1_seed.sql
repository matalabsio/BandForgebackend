...
-- Audio: listening/greenfield/part-1/full.mp3 (one clip for the whole part)
...
-- Shared form template (stored on Q1 passage_text; UI reads from first question)
-- Instructions + ASCII form layout from founder test/ screenshots
